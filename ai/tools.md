...
| goose     | [https://github.com/block/goose](https://github.com/block/goose)                   | Yes         | Yes            | No                                       | No          | Yes         | Yes    | Free (BYO model)        | Local-first CLI agent                             |
...
| opencode  | [https://github.com/opencode-ai/opencode](https://github.com/opencode-ai/opencode) | Yes         | Yes            | Yes (VS Code)                            | No          | Yes         | Yes    | Free + API              | CLI-first multi-model agent                       |
